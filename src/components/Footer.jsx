    ...
    <footer className='footer'>
      ...
      <div className='info'>
        ...
        <p>
          ...
          <span className='sd-hidden'> media or </span>
        </p>
        <p>
          <span className='sd-show'>media or </span> emial us at
          <br className='sd-show' />
          <span className='bold'> equalizer@example.com</span>
        </p>
      </div>
